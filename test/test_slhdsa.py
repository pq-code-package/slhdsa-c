...
if __name__ == '__main__':
    ...
    def slhdsa_print_kat(xbin, test, kat, i=0):
        for x in kat:
            s = xbin
            for t in x:
                if x[t] != "":
    ...
    xbin = './xfips205'
    slhdsa_print_kat(xbin, 'keyGen', keygen_kat)
    slhdsa_print_kat(xbin, 'sigGen', siggen_kat)
    slhdsa_print_kat(xbin, 'sigVer', sigver_kat)
